...
這是 Next.js + React 學習平台專案，使用 TypeScript、Tailwind CSS、shadcn/ui 風格元件、LocalStorage 與 chart.js。Phase 1 已整理成 Vercel 友善的正式路由架構。
...
- Server Actions：已建立作答紀錄儲存雛形，Phase 2 可替換為資料庫。
...
scripts              Windows 啟動、建置與 GitHub 推送腳本
src/app/api          AI API Routes
src/app/actions.ts   Server Actions 雛形
```
